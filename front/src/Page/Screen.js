                                            ...
                                            <>
                                                <div className='d-flex flex-column h-100 '>
                                                    ...
                                                    <div className='d-flex justify-content-center mb-3 mt-auto' >
                                                        <Button className='B_screen_btn fw-semibold p-2' onClick={() => setInvitePeople(true)}>
                                                            {/* <HiOutlineUserPlus className='fw-bold' style={{ fontSize: "20px" }} /> */}
                                                            <img src={inviteuser} alt="" className='j_invite_user_icon' />
                                                            Invite people
                                                        </Button>
